...
\begin{frame}{A \textit{'Good Trojan'} in Information Leakage}
    \begin{itemize}
\pause          
        \item \textbf{Size} The area of added circuit must be small due to extra energy consumption and 
                die size.
\pause          
        \item \textbf{Side-Channel Leakage} In order to leak information, the circuit must consume more energy
...
\pause          
        \item \textbf{Trigger} The attacker must be hard to be triggered. This is due to extensive functional 
                testing.
    \end{itemize}
\end{frame}
