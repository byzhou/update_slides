...
\begin{frame}{Some problems related}
    There are some problems related to the lef files. My guess is the lef file
    in the library has some problems. And the other parts like the drain and
    other stuff are not included in the lef files.
\end{frame}
...
\subsection{Other Layers on Standard Cells}
