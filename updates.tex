...
\begin{frame} {Single Gate Simulation}
    \begin{figure}[p]
        \includegraphics[width=2.5in]{../img/uni/fill_response.eps}~
        \includegraphics[width=2.5in]{../img/uni/uni_response.eps}
...
\begin{frame} {Circuit with Trojans Response}
    \begin{figure}[p]
        \includegraphics[width=2.5in]{../img/mul/fig/pre_In.eps}~
        \includegraphics[width=2.5in]{../img/mul/fig/In.eps}
...
\begin{frame} {Circuit without Trojans}
    \begin{figure}[p]
        \includegraphics[width=2.5in]{../img/mul/fig/pre_free.eps}~
        \includegraphics[width=2.5in]{../img/mul/fig/Free.eps}
...
\begin{frame} {Trojan Free Response}
    \begin{figure}[p]
        \includegraphics[width=4in]{../img/real/fig/free.eps}
...
\begin{frame} {Trojan In Response}
    \begin{figure}[p]
        \includegraphics[width=4in]{../img/real/fig/In.eps}
...
\begin{frame} {Trojan In minus Trojan Response}
    \begin{figure}[p]
        \includegraphics[width=4in]{../img/real/fig/In-Tj.eps}
...
\begin{frame} {Error Rate of False Alarm}
    \begin{figure}[p]
        \includegraphics[width=4in]{../img/real/mon/Free.eps}
        \caption{Error Rate of False Alarm}
    \end{figure}
\end{frame}
...
\begin{frame} {Error Rate of Miss Test}
    \begin{figure}[p]
        \includegraphics[width=4in]{../img/real/mon/In.eps}
        \caption{Error Rate of Miss Test}
    \end{figure}
\end{frame}
